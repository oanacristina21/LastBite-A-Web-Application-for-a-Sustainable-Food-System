...
import { Utensils, MapPin, Phone, Mail, Lock, CheckCircle, AlertCircle, Loader2, Settings, Leaf } from 'lucide-react'

export default function ProfilRestaurantPage() {
  ...
  useEffect(() => {
    async function fetchProfil() {
      try {
        const res = await fetch('/api/profil-restaurant')
      ...
      <div className="bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-700 text-white py-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          <div className="flex items-center gap-6 mb-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-white to-emerald-100 bg-clip-text text-transparent">
                Setări Profil Restaurant
              </h1>
              <p className="text-emerald-100 text-xl font-medium">Actualizează informațiile tale</p>
            </div>
          </div>
          <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3">
            ...
            <span className="text-emerald-100 font-semibold">Sustenabilitatea începe cu tine</span>
          </div>
        </div>
      </div>
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="denumire" className="text-emerald-700 font-medium flex items-center gap-2">
                    <Utensils size={16} />
                    Denumire Restaurant
                  </Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="adresa" className="text-emerald-700 font-medium flex items-center gap-2">
                    <MapPin size={16} />
                    Adresă
                  </Label>
                  <Input
